---
title: 'QM 2024 Week 10: Maximum Likelihood Estimation'
author:
- "Domantas Undzėnas"
- "Lisa-Marie Müller"
date: "November 07 | 08 , 2024"
output:
  html_document:
    toc: yes
    number_sections: yes
...
# How about a built in function? dbinom is the exact same function that we just wrote ourselves!

lik2 <- dbinom(x = 7, size = 10, p = p)

# Are both likelihoods the same?

all(round(lik, 6) == round(lik2, 6))
...
Both likelihood functions obviously lead to the same p, but are shifted.
